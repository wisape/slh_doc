...
html_theme_options = {
    ...
    'header_links' : [
        ("Home", "http://siweislh.com", True, 'home'),
        ('Book', 'index', False, 'launch'),
        (u"关于", "http://www.baidu.com", True, 'link')
    ],
...
latex_documents = [
    (master_doc, 'sphinx.tex', u'斯为数理化 Documentation',
     u'斯为', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphinx', u'斯为数理化 Documentation',
     [author], 1)
]
